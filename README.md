...
This script combines all the steps of the original manual setup scripts (below) to provide a fully operational node in approximately 15 minutes _( dependant on system specs & internet connection)_
