...
This script combines all the steps of the original manual setup scripts (below) to provide an operational node in approximately 15 minutes _( dependant on system specs & internet connection)_
